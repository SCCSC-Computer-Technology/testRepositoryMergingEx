<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InspectionReport.aspx.cs" Inherits="CPT_275_Capstone.AdminDashboard.InspectionReport" %>
...
<%--                <asp:Button ID="btnemail" runat="server" OnClick="btnemail_Click" Text="Email" Visible="False" />--%>
                ...
                <br />
                <br />
                <asp:Button ID="btnCancel" runat="server" Height="37px" Text="Cancel" Width="105px" OnClick="btnCancel_Click1" />
        ...
        <div>
            ...
            <asp:GridView ID="reportgried" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Height="196px" Width="1185px">
